    ...
    <ul class="navbar-nav float-left mr-auto">
        ...
        <li class="nav-item search-box"><a class="nav-link waves-effect waves-dark" href="javascript:void(0)"><i
            ...
            <form class="app-search position-absolute">
                <input type="text" class="form-control" placeholder="Search Name &amp; enter" name="search" id="search">
                <a
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                    src="images/{{$user_login->avatar}}" alt="user" class="rounded-circle" width="31"></a>
