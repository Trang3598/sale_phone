...
<header id="header" >
    <div class="col-sm-12">
        <div class="row header-content" style="display: flex;flex-direction: row;justify-content: center;padding: 20px 0">
            ...
            <div class="col-md-7  header-middle" style="display: flex;flex-direction: column;flex-wrap: wrap">
                <div class="list-items" style="height: 50%; display: flex;flex-direction: row;flex-wrap: wrap; align-items: center">
                    ...
                    <form action="{{route('search-product')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-group row" >
                            <div class="col-sm-8" style="display: flex;flex-direction: row">
                                <input type="text" class="form-control" id="search-data" value="" placeholder="Bạn tìm gì..." name="searchData">
                                <button type="submit" class="btn col-sm-2" style="height: 45px;background-color: #00BCD4"><i class="fa fa-search " ></i></button>
                            </div>
                        </div>
                    </form>
                </div>
            </div>
            <div id="cart" class="col-md-2 col-sm-12 col-xs-12" style="display: flex;align-items: center;flex-direction: row">
...
<section class="menu-bar">
    {{--    <div class="col-sm-12">--}}
    <div class="menu-bar-content " style="display: flex;flex-direction: row;flex-wrap: wrap; background-color: #2990ea; padding: 0 10px;color: white;height: 60px">
        ...
        <div class="row">
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                <div class="carousel-item active" >
                                    <img src="{{asset('images/' .$slides[0]->image)}}" alt="Los Angeles" style="width: 100%">
                                </div>
                                @for($i = 0;$i<sizeof($slides);$i++)
                                    <div class="carousel-item">
                                        <img src="{{asset('images/'.$slides[$i]->image)}}" alt="New York"  style="width: 100%">
                                    </div>
                                @endfor
                            </div>
            ...
            <div class="col-sm-12" style="margin-top: 10px; display: flex;flex-direction: row;flex-wrap: wrap">
                <div class="col-sm-6 sale" >
                    <img src="{{asset('client/img/home/banner-t-1.png')}}" alt="Los Angeles" style="width: 100%" class="">
                </div>
                <div class="col-sm-6 sale">
